...
function App() {
  ...
  const initalStates = {
    pagi, setPagi, pinnedPost, setPinnedPost, keyboardNav, setKeyboardNav, customCursor, setCustomCursor, sideImage, setSideImage, updatesTab, setUpdatesTab, sidebarLocation, setSidebarLocation,
